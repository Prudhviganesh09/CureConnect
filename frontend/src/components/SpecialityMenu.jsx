    ...
    <section className="py-20 px-4 md:px-10 lg:px-20" id='speciality'>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-3 text-primary font-bold hover:text-primary/80 transition-all duration-300 cursor-pointer group">
            <span className="text-lg">View all specialities</span>
